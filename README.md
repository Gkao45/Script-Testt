...
--------Autofram(5)---------
Section:NewToggle("Autofram(5)", "Click For Autofram(40-75)", function(state)
    _G.AutoFarm_Level = state
    _G.FastAttack = true
    ...
    function checklevel()
        local Level = game:GetService("Players").LocalPlayer.Data.Level.Value
        if Level == 40 or Level <= 75 then
            MON = "Brute [Lv. 45]"
            QUESTTITLE = "Brute"
            QUESTPOS = CFrame.new(-1140.4400634765625, 5.15206241607666, 3830.413330078125)
            MONPOS = CFrame.new(-1141.125, 14.809886932373047, 4339.74267578125)
            QUESTNAME = "BuggyQuest1"
            QUESTNUMBER = 2
            SPAWNPOINT = "Pirate"
            SPAWNPOINTPOS = CFrame.new(-1188.1103515625, 4.751567840576172, 3815.979248046875)
